...
export interface components {
    schemas: {
         ...
         * @description @see jetbrains://idea/navigate/reference?project=topvisor.com&fqn=Services\Broker_2\Methods\Keywords\Del
         */
        ...
        "Broker_2.Methods.Keywords.Del.Exec": (unknown[] | number | null) | null;
    };
    responses: never;
    parameters: never;
    requestBodies: never;
