...
export interface components {
    schemas: {
        ...
        "AiTracker_2.Methods.Summary.Chart.Get": {
            model_key: unknown;
        ...
        "AiTracker_2.Methods.Summary.Chart.Get.Exec": import('../../../../Models/KeywordsAi/Keywords.ts').components['schemas']['Models.KeywordsAi.Keywords'][];
    };
    responses: never;
    parameters: never;
    requestBodies: never;
