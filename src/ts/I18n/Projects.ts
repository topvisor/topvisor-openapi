...
export interface components {
    schemas: {
        "I18n.Projects": {
            ...
            /** @constant */
            readonly Delegating_impossible2: "You cannot give this user access to the project: currency in your accounts should be the same.\nAccount currency can be changed before the first payment with this instruction: <a href=\"https://{{ $site.host }}/support/bank/#currency\" target=\"_blank\">https://{{ $site.host }}/support/bank/#currency</a>";
            /** @constant */
            ...
            /** @constant */
            readonly Settings_no_automated_update_if_manual: "Do not run scheduled update if rankings have been checked on this day";
            /** @constant */
