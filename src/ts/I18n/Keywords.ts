...
export interface components {
    schemas: {
        "I18n.Keywords": {
            ...
            /** @constant */
            readonly No_keywords_in_project: "<a href=\"/support/keywords/import/\" target=\"_blank\">Add keywords</a> distributed across groups and folders or use our <a href=\"/semantic-core/\" target=\"_blank\">keyword research tools</a>.<br><br>To display columns with Volume, rankings and other, tap <b>All keywords</b> and button <i data-top-icon=\"\"></i> in the upper right corner.";
            /** @constant */
