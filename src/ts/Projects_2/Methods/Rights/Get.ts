...
export interface components {
    schemas: {
         ...
         * @description @see jetbrains://idea/navigate/reference?project=topvisor.com&fqn=Services\Projects_2\Methods\Rights\Get
         */
        ...
        "Projects_2.Methods.Rights.Get.Exec": import('../../../Models/Projects/Rights.ts').components['schemas']['Models.Projects.Rights'][];
    };
    responses: never;
    parameters: never;
    requestBodies: never;
