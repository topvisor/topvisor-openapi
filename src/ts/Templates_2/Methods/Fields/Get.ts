...
export interface components {
    schemas: {
         ...
         * @description @see jetbrains://idea/navigate/reference?project=topvisor.com&fqn=Services\Templates_2\Methods\Fields\Get
         */
        ...
        "Templates_2.Methods.Fields.Get.Exec": unknown[];
    };
    responses: never;
    parameters: never;
    requestBodies: never;
