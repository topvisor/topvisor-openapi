...
export interface components {
    schemas: {
         ...
         * @description @see jetbrains://idea/navigate/reference?project=topvisor.com&fqn=Services\System_2\Methods\Common\Tests\Speed\File\Get
         */
        ...
        "System_2.Methods.Common.Tests.Speed.File.Get.Exec": Record<string, never>;
    };
    responses: never;
    parameters: never;
    requestBodies: never;
