...
export interface components {
    schemas: {
        ...
        /** @enum {string} */
        "Content_2.Types.Subdomain": "" | "journal";
        /** @enum {string} */
        ...
        "Bank_2.Objects.Subscriptions.Subscription": {
            ...
            plan: components["schemas"]["Bank_2.Objects.Subscriptions.Plan"];
            /** Следующий план подписки */
            nextPlan?: components["schemas"]["Bank_2.Objects.Subscriptions.Plan"] | null;
            /** Состояние подписки */
            recurrentState: components["schemas"]["Bank_2.Objects.Requisites.Payment.RecurrentState"];
            /** Текущий цикл для подписки */
            cycle: components["schemas"]["Bank_2.Types.Subscriptions.Cycle"];
            /** Цикл для следующей подписки */
            nextCycle: components["schemas"]["Bank_2.Types.Subscriptions.Cycle"];
        ...
        "Content_2.Types.Pages.RequiredPosts": components["schemas"]["Content_2.Types.Pages.RequiredPost"][];
        "Content_2.Methods.Pages.AbstractPage": {
            ...
            user_id_3?: number | null;
            /** Дата публикации */
            create?: components["schemas"]["TV.API.Types.Date"] | null;
            /** Время публикации */
            publish_time?: components["schemas"]["TV.API.Types.Datetime"] | null;
            /** Заголовок страницы */
            h1?: string | null;
            ...
            required_posts_any?: components["schemas"]["Content_2.Types.Pages.RequiredPosts"] | null;
        };
        "Models.Pages": {
            "COUNT(*)"?: unknown;
            "RAND()"?: unknown;
    ...
    /** Изменение документа */
        ...
        "Content_2.Methods.Pages.Get": {
            ...
            url_for_edit?: components["schemas"]["TV.API.Types.Url"] | null;
            fields: components["schemas"]["fields"];
            orders: components["schemas"]["orders"];
            filters: components["schemas"]["filters"];
            id?: components["schemas"]["id"];
        ...
        "Content_2.Methods.Redirects.Add": {
            ...
            /** На поддомен */
            redirect_subdomain: components["schemas"]["Content_2.Types.Subdomain"];
            /** Сайт
             *
             *     - topvisor
             *     - thundo */
        ...
        "Content_2.Methods.Search.Get": {
            ...
            /** Искомая строка */
            search: string;
            /** Папка в которой производить поиск */
            folder?: string | null;
            fields: components["schemas"]["fields"];
            orders: components["schemas"]["orders"];
            filters: components["schemas"]["filters"];
        ...
        /** Типы частоты */
        "Keywords_2.Types.Volumes.Types": components["schemas"]["Keywords_2.Types.Volumes.Type"][];
        /**
        ...
        /** Форматыы отчета */
        "Schedule_2.Types.Settings.Formats": components["schemas"]["Schedule_2.Types.Settings.Format"][];
        /**
        ...
        "Schedule_2.Types.Settings.AdditionalFields": components["schemas"]["Schedule_2.Types.Settings.AdditionalField"][];
        /** Изменить дополнительные параметры расписания */
        "Schedule_2.Methods.Settings.Edit": {
            ...
            emails?: components["schemas"]["TV.API.Types.EmailArray"] | null;
            /** Отправить ли уведомление в информер */
            send_to_informer?: boolean | null;
            /** Id чатов телеграмма для рассылки уведомлений */
            telegram_chats_ids?: components["schemas"]["TV.API.Types.IntArray"] | null;
            ...
            regions_keys_by_searcher_key?: (string | number)[] | null;
            /** Имеет смысл только для Яндекс */
            volumes_types?: components["schemas"]["Keywords_2.Types.Volumes.Types"] | null;
            /** Добавить ли в отчет позиции конкурентов */
            with_competitors?: boolean | null;
            period?: components["schemas"]["Schedule_2.Types.Settings.Period"] | null;
            formats?: components["schemas"]["Schedule_2.Types.Settings.Formats"] | null;
            additional_fields?: components["schemas"]["Schedule_2.Types.Settings.AdditionalFields"] | null;
            /** Ссылка на sitemap */
        ...
        "Tickets_2.Methods.Tickets.Add": {
            ...
            site?: components["schemas"]["TV.Core.Sites.Sites"] | null;
        };
        /** Редактирование тикета */
...
export interface operations {
    ...
    GetContent2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Get"];
            };
        };
        responses: {
            200: {
    ...
    AbstractregularSchedule2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schedule_2.Methods.AbstractRegular"];
            };
        };
        responses: {
            200: {
    ...
    DelSchedule2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schedule_2.Methods.Del"];
            };
        };
        responses: {
            200: {
    ...
    EditSchedule2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schedule_2.Methods.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetSchedule2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schedule_2.Methods.Get"];
            };
        };
        responses: {
            200: {
    ...
    AddTemplates2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Templates_2.Methods.Add"];
            };
        };
        responses: {
            200: {
    ...
    DelTemplates2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Templates_2.Methods.Del"];
            };
        };
        responses: {
            200: {
    ...
    EditTemplates2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Templates_2.Methods.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetTemplates2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Templates_2.Methods.Get"];
            };
        };
        responses: {
            200: {
    ...
    GetWebscreens2: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Webscreens_2.Methods.Get"];
            };
        };
        responses: {
            200: {
    ...
    EditBroker2Ads: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Ads.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetBroker2Ads: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Ads.Get"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": ({
                        /** @throws Exception */
                        result: components["schemas"]["Models.Broker.Ads"][];
                    } & import('./ResponseSuccess.ts').components['schemas']['ResponseSuccess'] & import('./Pagination.ts').components['schemas']['Pagination']) | import('./ResponseError.ts').components['schemas']['ResponseError'];
                    model: components["schemas"]["Models.Broker.Ads"];
                };
            };
        };
    };
    AddBroker2Campaigns: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Campaigns.Add"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    ...
                    model: components["schemas"]["Models.Broker.Campaigns"];
                };
            };
        };
    };
    DelBroker2Campaigns: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Campaigns.Del"];
            };
        };
        responses: {
            200: {
    ...
    EditBroker2Campaigns: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Campaigns.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetBroker2Campaigns: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Campaigns.Get"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": ({
                        /** @throws Exception */
                        result: components["schemas"]["Models.Broker.Campaigns"][];
                    } & import('./ResponseSuccess.ts').components['schemas']['ResponseSuccess'] & import('./Pagination.ts').components['schemas']['Pagination']) | import('./ResponseError.ts').components['schemas']['ResponseError'];
                    model: components["schemas"]["Models.Broker.Campaigns"];
                };
            };
    ...
    AddBroker2Groups: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Groups.Add"];
            };
        };
        responses: {
            200: {
    ...
    GetBroker2Groups: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Groups.Get"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": ({
                        /** @throws Exception */
                        result: components["schemas"]["Models.Broker.Groups"][];
                    } & import('./ResponseSuccess.ts').components['schemas']['ResponseSuccess'] & import('./Pagination.ts').components['schemas']['Pagination']) | import('./ResponseError.ts').components['schemas']['ResponseError'];
                    model: components["schemas"]["Models.Broker.Groups"];
                };
            };
        };
    };
    DelBroker2Keywords: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Keywords.Del"];
            };
        };
        responses: {
            200: {
    ...
    EditBroker2Keywords: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Keywords.Edit"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    ...
                    model: components["schemas"]["Models.Broker.Keywords"];
                };
            };
        };
    };
    GetBroker2Keywords: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Keywords.Get"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": ({
                        /** @throws Exception */
                        result: components["schemas"]["Models.Broker.Keywords"][];
                    } & import('./ResponseSuccess.ts').components['schemas']['ResponseSuccess'] & import('./Pagination.ts').components['schemas']['Pagination']) | import('./ResponseError.ts').components['schemas']['ResponseError'];
                    model: components["schemas"]["Models.Broker.Keywords"];
                };
            };
    ...
    GetBroker2Log: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Log.Get"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": ({
                        /** @throws Exception */
                        result: components["schemas"]["Models.Broker.Log"][];
                    } & import('./ResponseSuccess.ts').components['schemas']['ResponseSuccess'] & import('./Pagination.ts').components['schemas']['Pagination']) | import('./ResponseError.ts').components['schemas']['ResponseError'];
                    model: components["schemas"]["Models.Broker.Log"];
                };
            };
        };
    };
    ...
    EditContent2BookmarkAuthor: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.BookmarkAuthor.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditContent2Bookmark: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Bookmark.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditContent2Like: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Like.Edit"];
            };
        };
        responses: {
            200: {
    ...
    AbstractpageContent2Pages: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Pages.AbstractPage"];
            };
        };
        responses: {
            200: {
    ...
    AddContent2Pages: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Pages.Add"];
            };
        };
        responses: {
            200: {
    ...
    DelContent2Pages: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Pages.Del"];
            };
        };
        responses: {
            200: {
    ...
    EditContent2Pages: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Pages.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetContent2Pages: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Pages.Get"];
            };
        };
        responses: {
            200: {
    ...
    AbstractregularContent2Redirects: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Redirects.AbstractRegular"];
            };
        };
        responses: {
            200: {
    ...
    GetContent2Search: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Search.Get"];
            };
        };
        responses: {
            200: {
    ...
    GetContent2Tags: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Tags.Get"];
            };
        };
        responses: {
            200: {
    ...
    GetExample2Bag: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Example_2.Methods.Bag.Get"];
            };
        };
        responses: {
            200: {
    ...
    EditPayments2Subscriptions: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Payments_2.Methods.Subscriptions.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditSchedule2Settings: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schedule_2.Methods.Settings.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetSchedule2Settings: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schedule_2.Methods.Settings.Get"];
            };
        };
        responses: {
            200: {
    ...
    GetSms2CheckPIN: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Sms_2.Methods.CheckPIN.Get"];
            };
        };
        responses: {
            200: {
    ...
    GetSms2SendPIN: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Sms_2.Methods.SendPIN.Get"];
            };
        };
        responses: {
            200: {
    ...
    GetTemplates2AvailableFieldsData: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Templates_2.Methods.AvailableFieldsData.Get"];
            };
        };
        responses: {
            200: {
    ...
    DelTemplates2Fields: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Templates_2.Methods.Fields.Del"];
            };
        };
        responses: {
            200: {
    ...
    EditTemplates2Fields: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Templates_2.Methods.Fields.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetTemplates2Fields: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Templates_2.Methods.Fields.Get"];
            };
        };
        responses: {
            200: {
    ...
    GetTemplates2FieldsProperties: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Templates_2.Methods.FieldsProperties.Get"];
            };
        };
        responses: {
            200: {
    ...
    GetBank2SubscriptionsPlans: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Bank_2.Methods.Subscriptions.Plans.Get"];
            };
        };
        responses: {
            200: {
    ...
    EditBroker2AdsStatus: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Ads.Status.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditBroker2AdsToModerate: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Ads.ToModerate.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditBroker2CampaignsUpdateTargeting: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Campaigns.UpdateTargeting.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetBroker2GroupsEditor: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Groups.Editor.Get"];
            };
        };
        responses: {
            200: {
    ...
    EditBroker2KeywordsStatus: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Keywords.Status.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetBroker2LogExport: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Log.Export.Get"];
            };
        };
        responses: {
    ...
    AddBroker2TasksRateTask: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Broker_2.Methods.Tasks.RateTask.Add"];
            };
        };
        responses: {
            200: {
    ...
    EditCompetitors2OrdersPay: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Competitors_2.Methods.Orders.Pay.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditContent2PagesOrder: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Content_2.Methods.Pages.Order.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditPayments2RecurrentSuspend: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Payments_2.Methods.Recurrent.Suspend.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditPayments2SubscriptionsNext: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Payments_2.Methods.Subscriptions.Next.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditPositions2CheckerGo: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Positions_2.Methods.Checker.Go.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetPositions2CheckerPrice: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Positions_2.Methods.Checker.Price.Get"];
            };
        };
        responses: {
            200: {
    ...
    GetRedmine2UsersGroups: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Redmine_2.Methods.Users.Groups.Get"];
            };
        };
        responses: {
            200: {
    ...
    EditReports2PositionsSendTest: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Reports_2.Methods.Positions.SendTest.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetSchedule2SettingsEmailsHints: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Schedule_2.Methods.Settings.EmailsHints.Get"];
            };
        };
        responses: {
            200: {
    ...
    EditAdmin2ActionsRegionsCommitGoogle: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Admin_2.Methods.Actions.Regions.CommitGoogle.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditAdmin2ActionsRegionsUpdateGoogle: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Admin_2.Methods.Actions.Regions.UpdateGoogle.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditAdmin2ActionsUserCurrency: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Admin_2.Methods.Actions.User.Currency.Edit"];
            };
        };
        responses: {
            200: {
    ...
    EditAdmin2ActionsUserEmail: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Admin_2.Methods.Actions.User.Email.Edit"];
            };
        };
        responses: {
            200: {
    ...
    GetProjects2TasksVolumesPrice: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Projects_2.Methods.Tasks.Volumes.Price.Get"];
            };
        };
        responses: {
            200: {
