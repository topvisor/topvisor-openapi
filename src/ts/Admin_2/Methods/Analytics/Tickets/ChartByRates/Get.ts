...
export interface components {
    schemas: {
         ...
         * @description @see jetbrains://idea/navigate/reference?project=topvisor.com&fqn=Services\Admin_2\Methods\Analytics\Tickets\ChartByRates\Get
         */
        ...
        "Admin_2.Methods.Analytics.Tickets.ChartByRates.Get.Exec": unknown[];
    };
    responses: never;
    parameters: never;
    requestBodies: never;
