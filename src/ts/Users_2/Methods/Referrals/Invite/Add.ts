...
export interface components {
    schemas: {
         ...
         * @description @see jetbrains://idea/navigate/reference?project=topvisor.com&fqn=Services\Users_2\Methods\Referrals\Invite\Add
         */
        ...
        "Users_2.Methods.Referrals.Invite.Add.Exec": number;
    };
    responses: never;
    parameters: never;
    requestBodies: never;
