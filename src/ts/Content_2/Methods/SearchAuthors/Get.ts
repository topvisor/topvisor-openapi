...
export interface components {
    schemas: {
        ...
        "Content_2.Methods.SearchAuthors.Get": {
            /** Фильтр по поддомену */
        ...
        "Content_2.Methods.SearchAuthors.Get.Exec": import('../../../Models/Content/Authors.ts').components['schemas']['Models.Content.Authors'][];
    };
    responses: never;
    parameters: never;
    requestBodies: never;
