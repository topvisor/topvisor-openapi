...
export interface components {
    schemas: {
        ...
        "Snapshots_2.Methods.History.Get": {
             ...
             * @description Сохраненные запросы будут выводиться в интерфейсе, если вы не хотите менять настройки интерфейса, то укажите `false`
             * @default true
             */
        ...
        "Snapshots_2.Methods.History.Get.Exec": import('../../Objects/History/Result/Result.ts').components['schemas']['Snapshots_2.Objects.History.Result.Result'];
    };
    responses: never;
    parameters: never;
    requestBodies: never;
