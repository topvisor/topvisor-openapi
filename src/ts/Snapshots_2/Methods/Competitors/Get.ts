...
export interface components {
    schemas: {
        ...
        "Snapshots_2.Methods.Competitors.Get.Exec": {
            competitors: {
                ...
                summariesData: {
                    [key: string]: {
                        ...
                        visibility?: number;
                        volumes_no_collected?: Snapshots_2MethodsCompetitorsGetExecCompetitorsSummariesDataVolumes_no_collected | Snapshots_2MethodsCompetitorsGetExecCompetitorsSummariesDataVolumes_no_collected | Snapshots_2MethodsCompetitorsGetExecCompetitorsSummariesDataVolumes_no_collected;
                        urls?: string[];
                    };
                };
                url?: string;
            ...
            volumes_no_collected?: Snapshots_2MethodsCompetitorsGetExecVolumes_no_collected | Snapshots_2MethodsCompetitorsGetExecVolumes_no_collected | Snapshots_2MethodsCompetitorsGetExecVolumes_no_collected;
            existsDates?: string[];
        };
    };
    responses: never;
...
export enum Snapshots_2MethodsCompetitorsGetExecCompetitorsSummariesDataVolumes_no_collected {
    Value0 = "0"
}
export enum Snapshots_2MethodsCompetitorsGetExecCompetitorsSummariesDataVolumes_no_collected {
    Value1 = "1"
...
export enum Snapshots_2MethodsCompetitorsGetExecVolumes_no_collected {
    Value0 = "0"
}
export enum Snapshots_2MethodsCompetitorsGetExecVolumes_no_collected {
    Value1 = "1"
